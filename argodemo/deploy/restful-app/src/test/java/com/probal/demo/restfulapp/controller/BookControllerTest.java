...
import com.probal.demo.restfulapp.RestBooksApplication;
import com.probal.demo.restfulapp.domain.Author;
...
@SpringBootTest(classes = RestBooksApplication.class)
